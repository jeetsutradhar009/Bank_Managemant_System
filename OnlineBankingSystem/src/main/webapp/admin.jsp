...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/style.css?v=1001">
        ...
        <section class="admin-content">
            ...
            <div class="admin-panel">
                ...
                <div class="admin-action-grid">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/add-user" class="admin-action-card">
                        <i class="bi bi-person-plus"></i>
                        <span>Add User</span>
                    </a>

                    <a href="${pageContext.request.contextPath}/admin/freeze-account" class="admin-action-card">
                        <i class="bi bi-lock"></i>
                        <span>Freeze Account</span>
                    </a>

                    <a href="${pageContext.request.contextPath}/admin/reports" class="admin-action-card">
                        <i class="bi bi-file-earmark-bar-graph"></i>
                        <span>Generate Report</span>
                    </a>

                    <a href="${pageContext.request.contextPath}/admin/audit-logs" class="admin-action-card">
                        <i class="bi bi-list-check"></i>
                        <span>Audit Logs</span>
                    </a>

                    <a href="${pageContext.request.contextPath}/admin/add-balance" class="admin-action-card">
                        <i class="bi bi-plus-circle"></i>
                        <span>Add Balance</span>
                    </a>

                    <a href="${pageContext.request.contextPath}/admin/reports/export" class="admin-action-card">
                        <i class="bi bi-download"></i>
                        <span>Backup</span>
                    </a>
